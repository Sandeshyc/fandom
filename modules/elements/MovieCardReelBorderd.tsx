...
const MovieCardReelBorderd: React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    ...
    className={`bg-[#101010]/60 group overflow-hidden col-span relative border-blue-700 border p-[1.8vw] pb-1 rounded-xl w-full transition-all duration-500 hover:border-white`}>
      ...
      <div className={`absolute z-20 bottom-0 left-0 w-full pb-[1.8vw] pt-[1.8vw] bg-gradient-to-t from-black from-45% via-black/80 via-75% to-transparent to-98% cursor-pointer`}>
          <div className='px-[1.8vw]'>
            <CardFooter footer={data?.footer} />
          </div>
          <div className='flex justify-between px-[2.4vw] group-hover:pr-[1.8vw] group-hover:pl-[1.8vw] transition-all'>
