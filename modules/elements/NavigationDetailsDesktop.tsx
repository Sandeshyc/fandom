...
const NavigationDetailsDesktop = () => {
  ...
  return (<nav className={`fixed top-0 left-0 w-full p-4 z-10 flex flex-row items-center gap-8 transition-opacity ease-in duration-700 ${(backBtnActive)?'opacity-50 cursor-wait':'opacity-100'} videoPageNav`}>
...
export default NavigationDetailsDesktop;