    ...
    if(textType === 'badge'){
        return (
            <div className='flex flex-wrap justify-center w-full'>
                <p className={`mx-auto text-center min-w-[100px] text-[10px] py-1 px-2 w-auto rounded-tl-lg rounded-tr-lg shadow-lg bg-gradient-to-l from-red-700 to-red-500 text-white shadow-indigo-500/40`}>
                    {text}
                </p>
            </div>
        )
