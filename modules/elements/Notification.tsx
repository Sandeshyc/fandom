...
const Notification = () => {
    ...
    return (
        <Menu as="div" className="relative text-left flex">
            <Menu.Button className="flex items-center px-2 sm:px-4 py-1 border-2 border-blue-500 rounded-[20px] lg:mr-6">
                <Notifications
                sx={{
                ...
                <span
                className='text-sm sm:text-base sm:font-semibold text-white'>
                    13                          
                </span>
            </Menu.Button>
            <Transition
                ...
                <Menu.Items 
                    className="absolute text-[16px] right-0 z-20 mt-2 w-[440px] max-w-[90vw] origin-top-right rounded-md bg-[#101010]/90 text-white focus:outline-none shadow-lg border-white/40 border">
