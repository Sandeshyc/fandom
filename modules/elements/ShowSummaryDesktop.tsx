...
const ShowSummaryDesktop = ({data, setCurrentSeason, currentSeason}:Props) => {
    ...
    return (
      <>
      <div className='text-white z-10 relative mt-[-100px] md:mt-[-250px] bg-gradient-to-t from-black from-30% to-transparent to-100%'>
...
export default ShowSummaryDesktop;
