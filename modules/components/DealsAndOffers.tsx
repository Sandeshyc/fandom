  ...
  return (
    <div className={`my-[4vw] px-3`}>
        ...
        style={{
            ...
            <div className='flex flex-col justify-between lg:flex-row flex-wrap items-center py-6 px-6 md:px-8 lg:px-12 xl:px-20 bg-gradient-to-b lg:bg-gradient-to-r from-[#0F0F0F] from-45% via-[#0245F2]/30 via-75% to-[#0245F2]/20 to-95%'
            style={{
                minHeight: '410px',
            }}>
                <div className='w-[100%] lg:w-[55%] mb-6 lg:mb-0'>
