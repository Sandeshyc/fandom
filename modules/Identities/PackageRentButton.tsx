...
const PackageRentButton = ({
    ...
    return (
        <>{(data?.allowed !== true)?(<button 
            ...
            className={`bg-gradient-to-r from-blue-700 to-blue-500 text-white rounded-full py-1 px-3 w-[180px] text-base transition h-[44px] ${className}`}
            style={styles}
        >Rent</button>):
        (<button
...
export default PackageRentButton;