          ...
          <div className='w-full pt-16'>
            <div className='container mx-auto'>
              <div className='max-w-[350px] w-[75%] mb-2'>
                <Skeleton baseColor='#aaa' highlightColor='#eee' height={50}/>
              </div>
              <div className='flex flex-wrap mb-2'>
                <div className='w-[120px] mr-2'>
                  <Skeleton baseColor='#aaa' highlightColor='#eee' height={40}/>
                </div>
                <div className='w-[120px] mr-2'>
                  <Skeleton baseColor='#aaa' highlightColor='#eee' height={40}/>
                </div>
                <div className='w-[300px] flex flex-wrap'>
                  <div className='w-[40px] mr-2'>
                    <Skeleton baseColor='#aaa' highlightColor='#eee' height={40} borderRadius={50}/>
                  </div>
                  <div className='w-[40px] mr-2'>
                    <Skeleton baseColor='#aaa' highlightColor='#eee' height={40} borderRadius={50}/>
                  </div>
              ...
              <div className='flex flex-wrap'>
                <div className='w-full sm:w-[65%]'>
                  <div className='w-[300px] max-w-[70%] mr-2'>
                    <Skeleton baseColor='#aaa' highlightColor='#eee' height={18}/>
                  </div>
                  <div className='w-[350px] max-w-[70%] mr-4'>
                    <Skeleton baseColor='#aaa' highlightColor='#eee' height={14}/>
                  </div>
                  <div className='w-[700px] max-w-full mr-2'>
                    <Skeleton baseColor='#aaa' highlightColor='#eee' height={14} count={3}/>
                  </div>
                </div>
          ...
          <div className='container mx-auto'>
            <div className="flex flex-wrap justify-between mb-4">
              <div className='w-[60%] max-w-[300px] mr-2'>
                <Skeleton baseColor='#aaa' highlightColor='#eee' height={30}/>
              </div>
