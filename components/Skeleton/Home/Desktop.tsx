  ...
  return (
    <div className="bg-black">
      <div className="pt-20 px-12">
        <div className='min-h-[300px] lg:min-h-[50vh] flex flex-col justify-end'>
          <div className="w-[500px] pb-4">
            <Skeleton baseColor='#333' highlightColor='#666' className='h-[45px] w-full' /> 
          </div>     
          <div className="w-[900px] pb-2">
            <Skeleton baseColor='#333' highlightColor='#666' className='h-[20px] w-full  pb-2' /> 
          </div>  
          <div className="w-[820px] pb-2">
            <Skeleton baseColor='#333' highlightColor='#666' className='h-[20px] w-full  pb-2' /> 
          </div>  
          <div className="w-[875px] pb-2">
            <Skeleton baseColor='#333' highlightColor='#666' className='h-[20px] w-full  pb-2' /> 
          </div>  
          <div className="w-[700px] pb-4">
            <Skeleton baseColor='#333' highlightColor='#666' className='h-[20px] w-full  pb-2' /> 
          </div>  
