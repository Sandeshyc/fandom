                ...
                <div className="w-full xl:w-1/2 ">            
                    <div className="flex flex-wrap justify-center h-full">
                        <div className="w-full max-w-[315px] sm:max-w-[448px] self-center">
                            <h1 className='text-white text-[18px] sm:text[24px] xl:text-[30px] mb-4 sm:mb-8 font-semibold  text-center '>Forget Password</h1>
                            <p className='text-white text-[14px] sm:text-[16px] xl:text-[18px] mb-2'>Email address.</p>
                            <form onSubmit={handleSubmit} method="POST">
                                <div className='mb-4'>
                                    <div className="relative">
                                        ...
                                        className='w-full text-white text-[14px] lg:text-[16px] px-2 py-1 pl-10 border rounded-md border-[#767680] h-[42px] sm:h-[46px] xl:h-[52px] bg-[#767680] bg-opacity-[22%] focus:bg-transparent'/>
